...
private Q_SLOTS:
  ...
  void publishDepthOnlyBounds();
  void estimateObjectInfo();
  void publishObjectInfoConfig();
  void resetFault();
  ...
  void planPolicyLoading();
  void abortPolicyLoading();
  void resetPolicyLoading();
  void setContinuousPolicyLoading(bool enabled);
  void setDepthOnlyEstimation(bool enabled);
...
private:
  ...
  QCheckBox * depth_only_estimation_;
  QLabel * box_dimensions_label_;
  QLabel * box_estimation_status_label_;
  QLabel * box_stability_label_;
  QSpinBox * depth_only_height_offset_;
  QSpinBox * contact_reference_z_;
  QLabel * object_info_state_label_;
  std::array<QSlider *, 6> depth_only_bounds_;
  std::array<QLabel *, 6> depth_only_bound_labels_;
  ...
  rclcpp::Client<std_srvs::srv::SetBool>::SharedPtr depth_only_estimation_client_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr box_diagnostics_sub_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr item_localization_status_sub_;
  rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr depth_only_bounds_pub_;
  rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr object_info_config_pub_;
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr estimate_object_info_client_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr object_info_status_sub_;
  ...
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr recover_ft_sensor_client_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr pickup_supervisor_status_sub_;
  ...
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr start_policy_loading_client_;
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr plan_policy_loading_client_;
